...
import com.localadmin.manager.feature.network.NetworkLog
...
val activateOrgProfileCommand = "dpm mark-profile-owner-on-organization-owned-device --user " +
        "${Binder.getCallingUid() / 100000} com.localadmin.manager/com.localadmin.manager.Receiver"
...
const val ACTIVATE_DEVICE_OWNER_COMMAND = "dpm set-device-owner com.localadmin.manager/.Receiver"
