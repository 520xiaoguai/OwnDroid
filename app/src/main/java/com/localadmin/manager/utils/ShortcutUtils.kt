package com.localadmin.manager.utils
...
import com.localadmin.manager.ShortcutsReceiverActivity
import com.localadmin.manager.feature.settings.SettingsRepository
import com.localadmin.manager.feature.user_restriction.UserRestrictionsRepository
import com.localadmin.manager.feature.users.UserOperationType
...
object ShortcutUtils {
        ...
        return ShortcutInfoCompat.Builder(context, shortcut.id)
            ...
            .setIntent(
                Intent(context, ShortcutsReceiverActivity::class.java)
                    .setAction("com.localadmin.manager.action.${shortcut.id}")
    ...
    fun createUserRestrictionShortcut(
        ...
        return ShortcutInfoCompat.Builder(context, "USER_RESTRICTION-$id")
            ...
            .setIntent(
                Intent(context, ShortcutsReceiverActivity::class.java)
                    .setAction("com.localadmin.manager.action.USER_RESTRICTION")
    ...
    fun buildUserOperationShortcut(
        ...
        return ShortcutInfoCompat.Builder(context, "USER_OPERATION-${type.name}-$serial")
            ...
            .setIntent(
                Intent(context, ShortcutsReceiverActivity::class.java)
                    .setAction("com.localadmin.manager.action.USER_OPERATION")
